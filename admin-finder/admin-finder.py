#!/usr/bin/python
# -------------------------------------------------
__AUTHOR__ = 'Artin or Error or error._.fiat'
__TELEGRAM_ID__ = '@Error_fiat'
__INSTAGRAM_ID__ = '@error._.fiat'
__GITHUB__ = 'https://github.com/errorfiathck'
...
from platform import system ; System = system()
